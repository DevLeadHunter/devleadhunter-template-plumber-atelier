...
export const mockSiteContent: SiteContent = {
  ...
  subtitle:
    'Dépannage, installation et rénovation à Nantes et alentours — un artisan de confiance, disponible 7j/7.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Nantes et les communes voisines de Loire-Atlantique. Vous êtes juste à côté ? Appelez pour vérifier, nous nous déplaçons souvent au-delà.',
    },
    {
  ...
  zones: ['Nantes', 'Saint-Herblain', 'Rezé', 'Orvault', 'Vertou', 'Carquefou'],
  openingHours: [
